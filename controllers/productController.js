...
async function getAllProducts(req, res) {
  try {
    ...
    // Re-sort by effective (discounted) price since SQL sorted by original price
    if (sort === 'price_asc') {
      productsWithDiscount.sort((a, b) => (a.Effective_Price || 0) - (b.Effective_Price || 0));
    } else if (sort === 'price_desc') {
      productsWithDiscount.sort((a, b) => (b.Effective_Price || 0) - (a.Effective_Price || 0));
    }
